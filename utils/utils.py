...
def select_samples_to_unlearn(data_splits_file, unlearn_samples_output_file, unlearn_ratio=0.1, target_class=None):
    ...
    if target_class is not None:
        ...
        combined_indices = [entry for entry in combined_indices if entry["class"] in target_class]
...
def select_targeted_samples_to_unlearn(data_splits_file, unlearn_samples_output_file, targeted_samples):
